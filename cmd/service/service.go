...
import (
	...
	prox "github.com/tickoalcantara12/micro/v3/service/proxy"
	"github.com/tickoalcantara12/micro/v3/service/proxy/grpc"
	"github.com/tickoalcantara12/micro/v3/service/proxy/http"
	"github.com/tickoalcantara12/micro/v3/service/proxy/mucp"
	rt "github.com/tickoalcantara12/micro/v3/service/runtime"
	"github.com/tickoalcantara12/micro/v3/service/server"
	ccli "github.com/urfave/cli/v2"

	// services
	api "github.com/tickoalcantara12/micro/v3/service/api/server"
	auth "github.com/tickoalcantara12/micro/v3/service/auth/server"
	broker "github.com/tickoalcantara12/micro/v3/service/broker/server"
	config "github.com/tickoalcantara12/micro/v3/service/config/server"
	events "github.com/tickoalcantara12/micro/v3/service/events/server"
	network "github.com/tickoalcantara12/micro/v3/service/network/server"
	proxy "github.com/tickoalcantara12/micro/v3/service/proxy/server"
	registry "github.com/tickoalcantara12/micro/v3/service/registry/server"
	runtime "github.com/tickoalcantara12/micro/v3/service/runtime/server"
	store "github.com/tickoalcantara12/micro/v3/service/store/server"

	// misc commands
	"github.com/tickoalcantara12/micro/v3/cmd/service/handler/exec"
	"github.com/tickoalcantara12/micro/v3/cmd/service/handler/file"
)
